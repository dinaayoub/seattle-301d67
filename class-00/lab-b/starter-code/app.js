...
// the arrow function makes it so that it inherits the scope ("this") of its parent, which in this case is Window,
// whereas when we try to set scope on a student object using a function, the scope will be that student object
